...
use Generator;
use NoobPress\Dependencies\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use NoobPress\Dependencies\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\NoobPress\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
